...
- 当前系统底座：六需求、起居、Utility AI、任务、传令、家具、社交、职业日课、身份礼法、关系、存档已形成第一版闭环。故事节点相关配置存在，但不作为当前核心架构依赖。
...
| 身份礼法 / 场景权限 | `持续更新_23身份礼法与场景权限.md` | `js/systems/identity-protocol.js`、`js/systems/scene-access.js` |
| 职业 / 职责 / 上下级 | `持续更新_24职业系统.md` | `js/systems/life-path.js`、`js/systems/specialty.js` |
| 传令 / 上下级管理 | `持续更新_25传令与上下级管理面板.md` | `js/ui.js`、`js/systems/quest-issue.js`、`js/systems/quest.js` |
| 秩序 / 第四轴玩法 | `持续更新_26_秩序管理与第四轴玩法.md` | `jiafu-order.html`、`js/jiafu-order-metadata.js`、后续 `OrderBookSystem` |
| 人物技能 / 成长 | `持续更新_27_人物技能与成长.md` | `js/systems/character-effects.js`、`js/action-queue.js`、`js/systems/quest.js`、`js/world.js` |
| 人生路径 / 故事节点（暂缓，不进核心依赖） | `持续更新_09人生路径与故事节点.md` | `js/systems/life-path.js`、`js/systems/fortune.js` |
...
| 新手引导 | `持续更新_28新手引导.md` | `js/ui.js`、`js/systems/quest.js`、后续 tutorial system |
...
| 任务/起居/传令/秩序方向 | `持续更新_29_任务起居传令与秩序方向.md` | 方向文，不作为立即实现清单 |
...
| 历史文件 | 已归档到 |
|---|---|
| `archive/0609_01_互动引入身份.md`、`archive/0612_02_身份系统大纲.md` | `持续更新_23身份礼法与场景权限.md` |
...
| `archive/0612_06_02_袭人晋升故事线.md`、`archive/0612_06_03_王熙凤晋升故事线和新系统框架.md` | `持续更新_09人生路径与故事节点.md`、`持续更新_24职业系统.md` |
